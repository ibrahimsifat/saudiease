            ...
            <div className="bg-white border border-gray-100 p-1.5 shadow-md md:rounded-full rounded flex space-x-1 will-change-transform flex-wrap">
              {categories.map((category) => (
                <button
                  ...
                  aria-label={`Filter services by ${category.name}`} // Added aria-label
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filteredServices.map((service, index) => (
              <motion.article // Changed to article for semantic HTML
                key={service.id}
                initial={{ opacity: 0, y: 20 }}
                  ...
                  <CardFooter className="pt-2 pb-6">
                    ...
                    >
                      <Link
                        ...
                        aria-label={`View details for ${service.title}`} // Added aria-label
                      >
                        {t("viewDetails")}
