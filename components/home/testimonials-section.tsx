    ...
    <section ref={containerRef} className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-saudi-black mb-4">What Our Saudi Clients Say</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Hear directly from businesses across the Kingdom about how our digital solutions have transformed their
            operations, improved compliance, and driven growth in the Saudi market.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-16">
          <motion.div style={{ y }} className="lg:col-span-5 relative">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 w-16 h-16 rounded-full bg-primary/10 z-0"></div>

              <Card className="bg-white p-8 rounded-xl shadow-xl relative z-10 border-none">
                <div className="absolute -top-5 -right-5 h-10 w-10 rounded-full bg-primary flex items-center justify-center shadow-lg">
                ...
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-saudi-black">{testimonials[activeIndex].name}</h4>
                    <p className="text-gray-600 text-sm">{testimonials[activeIndex].position}</p>
                    <p className="text-primary text-sm font-medium">{testimonials[activeIndex].company}</p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap items-center justify-between text-sm text-gray-600 pt-4 border-t border-gray-100">
                  <div className="flex items-center">
                    ...
                    <span>{testimonials[activeIndex].location}, Saudi Arabia</span>
                  </div>
                ...
                .map((testimonial, index) => (
                  ...
                  >
                    <div className="flex items-center mb-4">
                      <div className="relative h-12 w-12 rounded-full overflow-hidden mr-3 border border-primary/30">
                        <NextImage
                      ...
                      <div>
                        <h4 className="text-base font-semibold text-saudi-black">{testimonial.name}</h4>
                    ...
                    <p className="text-gray-700 text-sm line-clamp-3">"{testimonial.text}"</p>

                    <div className="mt-3 text-xs text-gray-500">Project: {testimonial.project}</div>
                  </motion.div>
                ))}
            </div>
