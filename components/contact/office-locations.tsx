  ...
  const offices = [
    {
      ...
      mapUrl: "https://maps.google.com/?q=King+Fahd+Road+Al+Olaya+District+Riyadh+Saudi+Arabia",
      isHeadquarters: true,
    },
    {
      city: "Jeddah",
      ...
      image: "/placeholder.svg?height=400&width=600",
      hours: "Sunday - Thursday: 9:00 AM - 6:00 PM",
      mapUrl: "https://maps.google.com/?q=Prince+Sultan+Road+Al+Rawdah+District+Jeddah+Saudi+Arabia",
  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <h3 className="text-xl font-bold text-saudi-black mb-4">Interactive Map</h3>
          <p className="text-gray-600 mb-6">Use the map below to find directions to our offices</p>
