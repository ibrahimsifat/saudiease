    ...
    <section className="relative pt-32 pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div ref={ref} className="max-w-3xl mx-auto text-center">
          ...
          >
            We're here to help with your digital transformation journey. Reach out to us through any of the channels
          ...
          >
            <div className="bg-white rounded-lg shadow-md px-6 py-4 border border-gray-100">
              ...
              <p className="text-lg font-semibold text-primary">+966 558845503</p>
            </div>

            <div className="bg-white rounded-lg shadow-md px-6 py-4 border border-gray-100">
              <p className="text-gray-600">Email us at</p>
              <p className="text-lg font-semibold text-primary">info@saudiease.com</p>
            </div>

            <div className="bg-white rounded-lg shadow-md px-6 py-4 border border-gray-100">
              <p className="text-gray-600">Business hours</p>
              <p className="text-lg font-semibold text-primary">Sun-Thu: 9AM-6PM</p>
            </div>
          </motion.div>
        </div>
      </div>
