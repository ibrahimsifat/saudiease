...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "Discover the latest digital marketing trends that are shaping the Saudi Arabian market this year.",
    content: `
    ...
    tags: ["Digital Marketing", "Saudi Arabia", "Marketing Trends", "Social Media", "SEO"],
    readTime: "5 min",
    featured: true,
    metaDescription:
  ...
  },
  {
    ...
    tags: ["E-Invoicing", "ZATCA", "Saudi Arabia", "Digital Transformation", "Business Efficiency"],
    readTime: "7 min",
    featured: true,
    metaDescription:
  ...
  },
  {
    ...
    category: "Web Design",
    tags: ["Mobile Design", "UX/UI", "Saudi Arabia", "Web Development", "User Experience"],
    readTime: "6 min",
    featured: false,
    metaDescription:
  ...
  },
  {
    ...
    category: "Finance Technology",
    tags: ["ZATCA", "E-Invoicing", "Tax Compliance", "Digital Transformation", "Saudi Regulations"],
    readTime: "10 min",
    featured: true,
    metaDescription:
  ...
  {
    id: 5,
    title: "Building Multilingual Websites: Best Practices for Saudi Businesses",
    ...
    tags: ["Multilingual Websites", "Arabic Web Design", "Localization", "International SEO", "User Experience"],
    readTime: "12 min",
    metaDescription:
  ...
  {
    id: 6,
    title: "Optimizing Website Performance for Saudi Arabia's Internet Infrastructure",
    ...
    image: "/placeholder.svg?height=400&width=600",
    date: "July 3, 2023",
    author: "Tariq Al-Farsi",
    authorImage: "/placeholder.svg?height=100&width=100",
    authorPosition: "Performance Engineering Lead",
    category: "Web Development",
    tags: ["Website Performance", "Page Speed", "Saudi Internet", "Mobile Optimization", "Technical SEO"],
    readTime: "14 min",
    metaDescription:
  ...
  },
  {
    ...
    category: "Digital Marketing",
    tags: ["Arabic SEO", "Search Engine Optimization", "Saudi Search", "Keyword Research", "Local SEO"],
    readTime: "15 min",
    metaDescription:
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=600",
    date: "August 7, 2023",
    author: "Samar Al-Harbi",
    authorImage: "/placeholder.svg?height=100&width=100",
    authorPosition: "UX Research Director",
    category: "UX/UI Design",
    tags: ["Arabic UX", "User Interface", "RTL Design", "Saudi User Experience", "Interface Design"],
    readTime: "13 min",
    metaDescription:
  ...
  {
    id: 9,
    title: "Vision 2030 Digital Transformation: Opportunities for Saudi Businesses",
    ...
    tags: ["Vision 2030", "Saudi Digital Transformation", "Economic Diversification", "Innovation", "Digital Economy"],
    readTime: "18 min",
    metaDescription:
  ...
  {
    id: 10,
    title: "Cybersecurity Best Practices for Saudi Businesses: Protecting Digital Assets",
    ...
    tags: ["Cybersecurity", "Data Protection", "Saudi Regulations", "Risk Management", "Information Security"],
    readTime: "16 min",
    metaDescription:
