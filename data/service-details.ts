...
export const serviceDetails: Record<string, ServiceDetail> = {
  "web-development": {
    ...
    faqs: [
      {
        question: "How long does it take to develop a website for my Saudi business?",
        answer:
      ...
      {
        question: "Will my website work well with Arabic content and right-to-left text?",
        answer:
      ...
      {
        question: "Do you provide website hosting services optimized for Saudi Arabia?",
        answer:
      ...
      {
        question: "How do you ensure my website will rank well in Saudi search engines?",
        answer:
      ...
      {
        question: "Can you integrate Saudi-specific payment gateways and shipping methods?",
        answer:
      ...
      {
        question: "How do you ensure my website will be accessible to all users in Saudi Arabia?",
        answer:
      ...
      {
        question: "Can you help with content creation for my Saudi business website?",
        answer:
    ...
    relatedServices: ["mobile-app-development", "e-commerce-solutions", "seo-services", "ui-ux-design"],
  },
  "mobile-app-development": {
    ...
    category: "development",
    pageTitle: "Mobile App Development Services in Saudi Arabia | iOS & Android",
    metaDescription:
    ...
    faqs: [
      {
        question: "How long does it take to develop a mobile app for my Saudi business?",
        answer:
      ...
      {
        question: "Should I develop a native app or a cross-platform app for the Saudi market?",
        answer:
      ...
      {
        question: "Can you integrate Saudi payment gateways into my mobile app?",
        answer:
      ...
      {
        question: "How do you ensure my app will be approved by Apple App Store and Google Play Store?",
        answer:
      ...
      {
        question: "Do you provide ongoing maintenance and updates for mobile apps?",
        answer:
      ...
      {
        question: "Can you help market my app to Saudi users after it's launched?",
        answer:
    ...
    relatedServices: ["web-development", "ui-ux-design", "e-commerce-solutions", "digital-marketing"],
  },
  "e-invoicing": {
    id: "e-invoicing",
    icon: null, // This will be filled from the services data
    title: "E-Invoicing & Accounts",
    description: "ZATCA-compliant electronic invoicing solutions and seamless account management for your business.",
    longDescription:
    ...
    faqs: [
      {
        question: "What are the current ZATCA e-invoicing requirements in Saudi Arabia?",
        answer:
      ...
      {
        question: "How quickly can you implement an e-invoicing solution for my business?",
        answer:
      ...
      {
        question: "Can your e-invoicing system integrate with our existing accounting software?",
        answer:
      ...
      {
        question: "Do you provide training for our staff on how to use the e-invoicing system?",
        answer:
      ...
      {
        question: "What happens if ZATCA regulations change after implementation?",
        answer:
      ...
      {
        question: "Can your system handle both simplified and standard tax invoices?",
        answer:
      ...
      {
        question: "Do you offer Arabic language support in your e-invoicing system?",
        answer:
    ...
    relatedServices: ["enterprise-solutions", "api-development", "custom-cms-development", "digital-marketing"],
  },
  "logo-design": {
    id: "logo-design",
    icon: null,
    ...
    faqs: [
      ...
      {
        question: "Can you incorporate specific cultural elements into my logo?",
        answer:
      ...
      {
        question: "How do you ensure my logo will be unique and not infringe on existing designs?",
        answer:
      ...
      {
        question: "Can you help with registering my logo as a trademark in Saudi Arabia?",
        answer:
    ...
    relatedServices: ["brand-identity", "corporate-profile", "print-design", "web-development"],
  },
  "digital-marketing": {
    ...
    caseStudies: [
      {
        title: "Comprehensive Digital Marketing Campaign for Al-Riyadh Furniture",
    ...
    faqs: [
      {
        question: "How do you tailor digital marketing strategies for the Saudi market?",
        answer:
      ...
      {
        question: "How do you handle advertising during Ramadan and other important cultural periods?",
        answer:
    ...
    relatedServices: ["web-development", "social-media-marketing", "content-marketing", "seo-services"],
  },
  "custom-cms-development": {
    ...
    technologies: [
      ...
      },
      {
        name: "GraphQL",
        icon: "Link",
        description: "A query language for APIs that enables efficient data retrieval and integration with your CMS.",
      },
      {
        name: "Docker",
        icon: "Server",
      ...
      },
      {
        name: "Cloud Hosting",
        icon: "Cloud",
        description: "Reliable and scalable hosting solutions for your CMS, ensuring high performance and uptime.",
      },
    ],
    caseStudies: [
      {
    ...
    faqs: [
      {
        question: "What is the difference between a custom CMS and an off-the-shelf solution?",
        answer:
      ...
      {
        question: "What ongoing support do you provide after the CMS is launched?",
        answer:
    ...
    relatedServices: ["web-development", "e-commerce-solutions", "api-development", "enterprise-solutions"],
  },
  "enterprise-solutions": {
    ...
    category: "development",
    pageTitle: "Enterprise Solutions for Saudi Businesses | Custom ERP & CRM Systems",
    metaDescription:
      "Custom enterprise solutions for Saudi organizations. Scalable, secure, and efficient systems that streamline operations, enhance productivity, and ensure compliance with local regulations.",
    metaKeywords: [
      "enterprise solutions Saudi Arabia",
      "custom ERP systems KSA",
      "CRM development Riyadh",
      "business process automation",
      "enterprise software Saudi",
      "legacy system integration",
      "data analytics solutions",
      "Saudi enterprise software",
      "Vision 2030 digital transformation",
    ],
    heroImage: "/placeholder.svg?height=800&width=1600",
    overview:
      "Our Enterprise Solutions services provide Saudi businesses with custom software systems that address their unique operational challenges. From custom ERP and CRM platforms to business process automation and data analytics, we build scalable, secure, and efficient solutions that streamline operations, enhance productivity, and support decision-making. Our solutions are designed to integrate seamlessly with your existing systems, ensuring a smooth transition and minimal disruption to your business.",
    sections: [
      {
        title: "Custom ERP Systems",
        content:
          "We develop custom ERP systems tailored to your business needs, integrating key functions such as finance, HR, supply chain, and inventory management. Our ERP solutions are designed to improve operational efficiency, provide real-time insights, and support decision-making across your organization.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "CRM Development",
        content:
          "Our custom CRM platforms help you manage customer relationships more effectively, with features for sales automation, marketing, customer support, and analytics. We build CRM systems that integrate with your existing tools and provide a 360-degree view of your customers.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Business Process Automation",
        content:
          "We automate repetitive and time-consuming tasks, streamlining workflows and reducing manual errors. Our automation solutions are designed to improve efficiency, reduce costs, and free up your team to focus on higher-value activities.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Data Analytics & Reporting",
        content:
          "We build data analytics platforms that provide actionable insights into your business performance. Our solutions include dashboards, reporting tools, and predictive analytics to support data-driven decision-making.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Legacy System Integration",
        content:
          "We help you modernize your IT infrastructure by integrating legacy systems with new technologies. Our solutions ensure data consistency, improve system performance, and extend the lifespan of your existing investments.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    process: [
      {
        title: "Requirement Analysis",
        description:
          "We work closely with your team to understand your business needs, challenges, and goals, ensuring our solutions align with your objectives.",
        icon: "ClipboardList",
      },
      {
        title: "Solution Design",
        description:
          "We design the architecture of your enterprise solution, including system integration, data flow, and user interfaces.",
        icon: "Layout",
      },
      {
        title: "Development",
        description:
          "Our team builds the solution using modern technologies, focusing on scalability, security, and performance.",
        icon: "Code",
      },
      {
        title: "Integration",
        description:
          "We integrate the new system with your existing tools and platforms, ensuring seamless data flow and minimal disruption.",
        icon: "Link",
      },
      {
        title: "Testing",
        description:
          "We conduct rigorous testing to ensure the system functions flawlessly and meets your business requirements.",
        icon: "CheckCircle",
      },
      {
        title: "Deployment",
        description:
          "We deploy the solution to your production environment, providing training and support to ensure a smooth transition.",
        icon: "Rocket",
      },
      {
        title: "Support",
        description:
          "We offer ongoing support and maintenance to keep your system running smoothly and adapt to your evolving needs.",
        icon: "HeadSet",
      },
    ],
    technologies: [
      {
        ...
        icon: "Database",
        description:
          "A leading ERP platform that we customize to meet your specific business needs, with support for complex workflows and large-scale operations.",
      },
      {
        name: "Salesforce",
        icon: "Users",
        description:
          "A powerful CRM platform that we tailor to your customer management needs, with features for sales, marketing, and customer support.",
      },
      {
        name: "Microsoft Dynamics",
        icon: "Server",
        description:
          "A flexible ERP and CRM solution that we customize to integrate with your existing systems and support your business processes.",
      },
      {
        name: "Power BI",
        icon: "BarChart",
        description:
          "A data analytics tool that we use to build interactive dashboards and reports, providing actionable insights into your business performance.",
      },
      {
        name: "AWS",
        icon: "Cloud",
        description:
          "A scalable cloud platform that we use to host and manage your enterprise solutions, ensuring high performance and reliability.",
      },
      {
        name: "Docker",
        icon: "Server",
        description:
          "A containerization platform that ensures your enterprise applications run consistently across different environments.",
      },
      {
        name: "Kubernetes",
        icon: "Layers",
        description:
          "An orchestration tool for managing containerized applications, ensuring scalability and high availability.",
      },
    ],
    caseStudies: [
      {
        title: "Custom ERP for Saudi Manufacturing Company",
        client: "Al-Riyadh Manufacturing",
        description:
          "Developed a custom ERP system for a Saudi manufacturing company, integrating finance, supply chain, and inventory management. The solution included features for real-time tracking, automated reporting, and predictive analytics.",
        results:
          "30% improvement in operational efficiency, 20% reduction in inventory costs, and enhanced decision-making with real-time insights.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "CRM Platform for Saudi Telecom Provider",
        client: "Saudi Telecom Company",
        description:
          "Built a custom CRM platform for a leading Saudi telecom provider, integrating sales, marketing, and customer support functions. The platform included features for customer segmentation, campaign management, and analytics.",
        results:
          "25% increase in customer retention, 40% improvement in sales team productivity, and enhanced customer satisfaction with faster support.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Business Process Automation for Saudi Retail Chain",
        client: "Saudi Retail Group",
        description:
          "Automated key business processes for a Saudi retail chain, including inventory management, order processing, and customer communications. The solution integrated with their existing ERP and CRM systems.",
        results:
          "50% reduction in manual errors, 30% faster order processing, and improved customer experience with automated notifications.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
      {
        question: "What industries do you serve with enterprise solutions?",
        answer:
          "We serve a wide range of industries, including manufacturing, retail, healthcare, telecom, and government. Our solutions are tailored to meet the unique needs of each industry, ensuring compliance with local regulations and industry standards.",
      },
      {
        question: "How do you ensure data security in enterprise solutions?",
        answer:
          "We implement multiple layers of security, including data encryption, role-based access control, regular security audits, and compliance with industry standards. Our solutions are designed to protect your sensitive business data and ensure compliance with local regulations.",
      },
      {
        question: "Can you integrate enterprise solutions with legacy systems?",
        answer:
          "Yes, we specialize in integrating new enterprise solutions with legacy systems, ensuring data consistency and minimizing disruption to your business. Our integration approach includes data migration, API development, and middleware solutions.",
      },
      {
        question: "How long does it take to develop a custom enterprise solution?",
        answer:
          "The timeline for developing a custom enterprise solution depends on the complexity of your requirements. Simple solutions can be completed in 3-6 months, while more complex systems may take 6-12 months. We provide a detailed timeline during the planning phase.",
      },
      {
        question: "Do you provide training for using enterprise solutions?",
        answer:
          "Yes, we offer comprehensive training for your team to ensure they can use the new system effectively. Training includes hands-on sessions, documentation, and ongoing support.",
      },
      {
        question: "What ongoing support do you provide after deployment?",
        answer:
          "We offer ongoing support and maintenance to keep your enterprise solution running smoothly. This includes regular updates, security patches, performance optimization, and technical support to address any issues.",
      },
      {
        question: "Can enterprise solutions be scaled as my business grows?",
        answer:
          "Yes, our enterprise solutions are designed to be scalable, allowing you to add new features, users, and integrations as your business evolves. We ensure your system can grow with your needs.",
      },
      {
        question: "How do you ensure compliance with Saudi regulations?",
        answer:
          "We stay up-to-date with Saudi regulations and ensure our solutions comply with local laws, including data protection, financial reporting, and industry-specific requirements. Our team includes experts in Saudi compliance to guide the development process.",
      },
    ],
    relatedServices: ["custom-cms-development", "api-development", "e-invoicing", "mobile-app-development"],
  },
  "e-commerce-solutions": {
    ...
    category: "development",
    pageTitle: "E-commerce Solutions for Saudi Businesses | Online Store Development",
    metaDescription:
    ...
    process: [
      ...
      {
        title: "Support",
        description: "We offer ongoing support and maintenance to keep your e-commerce platform running smoothly.",
        icon: "HeadSet",
      },
    ],
    technologies: [
      ...
      },
      {
        ...
        icon: "BarChart",
        description: "A powerful analytics tool that provides insights into customer behavior and sales performance.",
      },
    ],
    caseStudies: [
      {
    ...
    relatedServices: ["web-development", "mobile-app-development", "seo-services", "digital-marketing"],
  },
  "brand-identity": {
    id: "brand-identity",
    icon: null,
    ...
    category: "design",
    pageTitle: "Brand Identity Design Services in Saudi Arabia | Logo & Visual Identity",
    metaDescription:
    ...
    caseStudies: [
      ...
      },
      {
        ...
        results: "Increased customer engagement, improved brand perception, and higher sales across all stores.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Enhanced brand recognition, successful funding rounds, and positive media coverage.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
    ...
    relatedServices: ["logo-design", "corporate-profile", "print-design", "web-development"],
  },
  "api-development": {
    id: "api-development",
    icon: null,
    ...
    category: "development",
    pageTitle: "API Development Services in Saudi Arabia | Custom API Integration",
    metaDescription:
    ...
    technologies: [
      {
        name: "Node.js",
        icon: "Code",
        description: "A server-side JavaScript runtime for building scalable and efficient APIs with high performance.",
      },
      {
        name: "Express.js",
        icon: "Server",
      ...
      },
      {
        name: "Postman",
        icon: "Tool",
        description: "A tool for API testing and documentation, ensuring your APIs are functional and well-documented.",
      },
      {
        name: "OAuth",
        icon: "Shield",
        description: "An authentication protocol for securing APIs and ensuring authorized access to your data.",
      },
      {
        name: "Swagger",
        icon: "Book",
        description: "A framework for API documentation that ensures clarity and ease of use for developers.",
      },
      {
        name: "AWS API Gateway",
        icon: "Cloud",
        description: "A fully managed service for creating, publishing, and securing APIs at scale.",
      },
    ],
    caseStudies: [
      {
        ...
        results: "Improved operational efficiency, reduced delivery times, and enhanced customer satisfaction.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Increased sales, reduced cart abandonment, and improved inventory management.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Faster booking process, improved user experience, and higher customer retention.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes, we specialize in integrating third-party APIs to extend the functionality of your applications.",
      },
      {
    ...
    relatedServices: ["web-development", "mobile-app-development", "e-commerce-solutions", "cloud-services"],
  },
  "corporate-profile": {
    ...
    category: "design",
    pageTitle: "Corporate Profile Design Services in Saudi Arabia | Professional Branding",
    metaDescription:
    ...
    process: [
      ...
      {
        title: "Finalization",
        description: "We finalize the corporate profile, ensuring it is ready for print and digital distribution.",
        icon: "CheckCircle",
      },
      {
        title: "Delivery",
    ...
    technologies: [
      {
        name: "Adobe InDesign",
        icon: "PenTool",
        description: "Industry-standard software for creating professional layouts and designs for corporate profiles.",
      },
      {
        name: "Adobe Illustrator",
        icon: "Image",
        description: "Professional design software for creating brand-aligned visuals and graphics for your profile.",
      },
      {
        name: "Adobe Photoshop",
        icon: "Image",
        description: "Image editing software for enhancing visuals and ensuring high-quality graphics in your profile.",
      },
      {
        name: "Microsoft Word",
        icon: "FileText",
        description: "A versatile tool for creating and editing content for your corporate profile.",
      },
      {
        name: "PDF Tools",
        icon: "File",
    ...
    caseStudies: [
      {
        ...
        results: "Enhanced brand credibility, increased stakeholder trust, and improved business opportunities.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Improved patient trust, increased brand recognition, and enhanced stakeholder engagement.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Successful funding rounds, positive media coverage, and increased investor interest.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
    ...
    relatedServices: ["brand-identity", "print-design", "web-development", "content-marketing"],
  },
  "ui-ux-design": {
    id: "ui-ux-design",
    icon: null,
    ...
    category: "design",
    pageTitle: "UI/UX Design Services in Saudi Arabia | User-Centric Digital Experiences",
    metaDescription:
    ...
    process: [
      ...
      {
        title: "User Research",
        description: "We conduct user research to gather insights into user needs, preferences, and behaviors.",
        icon: "Users",
      },
      {
        title: "Wireframing",
        description: "We create wireframes to outline the structure and layout of the interface.",
        icon: "Layout",
      },
      {
        title: "Prototyping",
        description: "We develop interactive prototypes to visualize the user flow and functionality.",
        icon: "PenTool",
      },
      {
        title: "Design",
        description: "We design the final interface, focusing on aesthetics, usability, and responsiveness.",
        icon: "Image",
      },
      {
        title: "Testing",
        description: "We conduct usability testing to identify and fix any issues before launch.",
        icon: "CheckCircle",
      },
      {
        title: "Launch",
        description: "We deliver the final design and provide support for implementation and optimization.",
        icon: "Rocket",
      },
    ],
    technologies: [
      {
        name: "Figma",
        icon: "PenTool",
        description: "A collaborative design tool for creating wireframes, prototypes, and high-fidelity designs.",
      },
      {
        name: "Sketch",
        icon: "Image",
        description: "A vector-based design tool for creating intuitive and scalable user interfaces.",
      },
      {
        name: "Adobe XD",
        icon: "Layout",
        description: "A design and prototyping tool for creating interactive and responsive interfaces.",
      },
      {
        name: "InVision",
        icon: "PlayCircle",
        description: "A prototyping tool for creating interactive mockups and gathering user feedback.",
      },
      {
        name: "UsabilityHub",
        icon: "CheckCircle",
        description: "A platform for conducting usability testing and gathering insights to improve designs.",
      },
      {
        name: "Zeplin",
        icon: "Code",
        description: "A collaboration tool for designers and developers to ensure seamless implementation.",
      },
    ],
    caseStudies: [
      {
        ...
        results: "Increased conversion rates, reduced bounce rates, and improved customer satisfaction.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Improved patient engagement, higher app retention rates, and positive user feedback.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Increased bookings, improved user satisfaction, and higher customer retention.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes, we design responsive and adaptive interfaces for both web and mobile platforms.",
      },
      {
    ...
    relatedServices: ["web-development", "mobile-app-development", "brand-identity", "e-commerce-solutions"],
  },
  "motion-graphics": {
    id: "motion-graphics",
    icon: null,
    ...
    description:
      "Engaging motion graphics and animations to bring your brand story to life and captivate your audience.",
    longDescription:
      "We create dynamic and visually stunning motion graphics that communicate your brand message effectively. From explainer videos to promotional animations, our motion graphics are designed to captivate your audience and leave a lasting impression.",
    benefits: [
    ...
    category: "design",
    pageTitle: "Motion Graphics Services in Saudi Arabia | Engaging Brand Animations",
    metaDescription:
      "Bring your brand story to life with our motion graphics services. We create engaging animations and explainer videos to captivate your audience in Saudi Arabia.",
    metaKeywords: [
      "motion graphics Saudi Arabia",
      "2D animation Riyadh",
      "3D animation KSA",
      "explainer videos Saudi",
      "promotional animations",
      "logo animation services",
      "Vision 2030 motion graphics",
    ],
    heroImage: "/placeholder.svg?height=800&width=1600",
    overview:
      "Our Motion Graphics services help Saudi businesses communicate their brand message in a visually engaging way. Whether it’s an explainer video, promotional animation, or logo animation, we create dynamic content that resonates with your audience and enhances your brand presence.",
    sections: [
      {
        title: "2D & 3D Animations",
        content:
          "We create both 2D and 3D animations to bring your ideas to life. Our animations are tailored to your brand and designed to captivate your audience.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Explainer Videos",
        content: "We produce explainer videos that simplify complex concepts and communicate your message effectively.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Promotional Animations",
        content: "We design promotional animations that highlight your products or services and drive engagement.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Logo Animations",
        content: "We create dynamic logo animations that make your brand stand out and leave a lasting impression.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Social Media Animations",
        content:
          "We design animations optimized for social media platforms to boost your online presence and engagement.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    process: [
      {
        title: "Concept Development",
        description: "We start by understanding your brand and developing a concept that aligns with your goals.",
        icon: "Lightbulb",
      },
      {
        title: "Storyboarding",
        description: "We create a storyboard to visualize the flow and structure of the animation.",
        icon: "Layout",
      },
      {
        title: "Design",
        description: "We design the visual elements, including characters, backgrounds, and assets.",
        icon: "PenTool",
      },
      {
        title: "Animation",
        description: "We bring the design to life through motion, adding effects and transitions.",
        icon: "PlayCircle",
      },
      {
        title: "Review & Feedback",
        description: "We present the draft animation for your review and incorporate your feedback.",
        icon: "Presentation",
      },
      {
        title: "Finalization",
        description: "We finalize the animation and deliver it in your preferred format.",
        icon: "CheckCircle",
      },
    ],
    technologies: [
      {
        ...
        icon: "PlayCircle",
        description: "Industry-standard software for creating dynamic motion graphics and animations.",
      },
      {
        name: "Cinema 4D",
        icon: "Film",
        description: "A 3D modeling and animation tool for creating high-quality 3D animations.",
      },
      {
        name: "Blender",
        icon: "Film",
        description: "An open-source 3D animation tool for creating professional-grade animations.",
      },
      {
        name: "Adobe Premiere Pro",
        icon: "Video",
        description: "A video editing tool for adding finishing touches to your animations.",
      },
    ],
    caseStudies: [
      {
        ...
        results: "Increased customer understanding, higher engagement, and improved conversion rates.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Promotional Animation for Saudi Retail Brand",
        client: "Saudi Retail",
        description: "Designed a promotional animation to highlight the client’s new product line and drive sales.",
        results: "Increased product awareness, higher sales, and improved brand recognition.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Logo Animation for Saudi Tech Company",
        client: "TechWave Arabia",
        description:
          "Created a dynamic logo animation to enhance the client’s brand identity and leave a lasting impression.",
        results: "Improved brand recognition, higher engagement, and positive customer feedback.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "2D animation is flat and focuses on movement in two dimensions, while 3D animation adds depth and realism by simulating three-dimensional space.",
      },
      {
        question: "How long does it take to create a motion graphic?",
        answer:
          "The timeline depends on the complexity of the project. Simple animations can take 2-4 weeks, while more complex projects may take 6-8 weeks.",
      },
      {
        question: "Can you create animations for social media?",
        answer:
          "Yes, we design animations optimized for social media platforms to boost your online presence and engagement.",
      },
      {
        question: "Do you provide voiceovers for explainer videos?",
        answer: "Yes, we can provide professional voiceovers in multiple languages, including Arabic and English.",
      },
      {
        question: "How do you ensure brand alignment in animations?",
        answer: "We incorporate your brand’s colors, typography, and visual style to ensure consistency and alignment.",
      },
    ],
    relatedServices: ["video-marketing", "brand-identity", "social-media-marketing", "content-marketing"],
  },
  "print-design": {
    id: "print-design",
    icon: null,
    ...
    category: "design",
    pageTitle: "Print Design Services in Saudi Arabia | Professional Branding Materials",
    metaDescription:
    ...
    process: [
      ...
      {
        title: "Concept Development",
        description: "We develop design concepts that align with your brand identity and project goals.",
        icon: "Lightbulb",
      },
      {
        title: "Design",
        description: "We create the final design, incorporating your feedback and ensuring it meets your expectations.",
        icon: "PenTool",
      },
      {
        title: "Review & Feedback",
        description: "We present the draft design for your review and incorporate your feedback to refine the design.",
        icon: "Presentation",
      },
      {
        title: "Finalization",
        description: "We finalize the design and prepare it for print, ensuring high-quality output.",
        icon: "CheckCircle",
      },
      {
        title: "Delivery",
        description: "We deliver the final design files and provide support for printing and production.",
        icon: "Package",
      },
    ],
    technologies: [
      {
        name: "Adobe InDesign",
        icon: "PenTool",
        description: "Industry-standard software for creating professional layouts and designs for print materials.",
      },
      {
        name: "Adobe Illustrator",
        icon: "Image",
        description: "Professional design software for creating vector-based graphics and illustrations.",
      },
      {
        name: "Adobe Photoshop",
        icon: "Image",
        description: "Image editing software for enhancing visuals and ensuring high-quality graphics.",
      },
      {
        name: "Pantone Color Matching",
        icon: "Droplet",
        description: "Tools for ensuring accurate color reproduction in print materials.",
      },
      {
        name: "Print Production Tools",
        icon: "Printer",
        description: "Tools for preparing designs for print, including bleed, trim, and crop marks.",
      },
    ],
    caseStudies: [
      {
        ...
        results: "Increased customer engagement, improved brand credibility, and higher sales inquiries.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Enhanced brand recognition, positive client feedback, and increased networking opportunities.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Increased sales, improved brand loyalty, and positive customer feedback.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
    ...
    relatedServices: ["brand-identity", "corporate-profile", "motion-graphics", "social-media-marketing"],
  },
  "seo-services": {
    id: "seo-services",
    icon: null,
    ...
    process: [
      {
        ...
        description: "We start by conducting a comprehensive audit of your website to identify areas for improvement.",
        icon: "Search",
      },
      {
        title: "Keyword Research",
        description: "We identify high-value keywords that align with your business goals and target audience.",
        icon: "FileSearch",
      },
      {
      ...
      {
        title: "Reporting & Analysis",
        description: "We provide detailed reports and analytics to track your website’s performance and progress.",
        icon: "BarChart",
      },
    ],
    technologies: [
      {
        name: "Google Analytics",
        icon: "BarChart",
        description: "A powerful analytics tool for tracking website traffic, user behavior, and SEO performance.",
      },
      {
        name: "Google Search Console",
        icon: "Search",
        description: "A tool for monitoring and optimizing your website’s presence in Google search results.",
      },
      {
        name: "Ahrefs",
        icon: "Link",
        description: "An SEO tool for keyword research, backlink analysis, and competitor analysis.",
      },
      {
        name: "SEMrush",
        icon: "TrendingUp",
        description: "An all-in-one SEO tool for keyword research, site audits, and performance tracking.",
      },
      {
        name: "Screaming Frog",
        icon: "Settings",
        description: "A technical SEO tool for crawling websites and identifying issues.",
      },
    ],
    caseStudies: [
      {
        ...
        results: "Increased organic traffic by 60%, higher search engine rankings, and improved conversion rates.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Increased foot traffic, higher online reservations, and improved local search rankings.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Increased organic traffic by 50%, higher patient inquiries, and improved online visibility.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
      ...
      {
        question: "Can you optimize my website for both Arabic and English keywords?",
        answer:
    ...
    relatedServices: ["digital-marketing", "content-marketing", "social-media-marketing", "web-development"],
  },
  "social-media-marketing": {
    ...
    category: "marketing",
    pageTitle: "Social Media Marketing Services in Saudi Arabia | Grow Your Online Presence",
    metaDescription:
    ...
    process: [
      ...
      {
        title: "Optimization",
        description: "We optimize your campaigns and content based on performance data to achieve better results.",
        icon: "TrendingUp",
      },
    ],
    technologies: [
      {
        ...
        icon: "Facebook",
        description: "A tool for creating and managing paid ad campaigns on Facebook and Instagram.",
      },
      {
        name: "Hootsuite",
        icon: "Calendar",
      ...
      },
      {
        name: "Canva",
        icon: "Image",
        description: "A design tool for creating visually appealing social media graphics and videos.",
      },
      {
        name: "Google Analytics",
        icon: "BarChart",
        description: "A tool for tracking website traffic and conversions from social media campaigns.",
      },
      {
        name: "LinkedIn Ads",
        icon: "Linkedin",
        description: "A platform for running targeted ad campaigns on LinkedIn to reach professionals and businesses.",
      },
    ],
    caseStudies: [
      {
        ...
        results: "Increased followers by 40%, higher engagement rates, and a 25% increase in online sales.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Generated 200+ leads, increased website traffic by 50%, and improved brand visibility.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Improved customer satisfaction, higher engagement rates, and increased repeat customers.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes, we create content in both Arabic and English to cater to the bilingual Saudi market.",
      },
      {
    ...
    relatedServices: ["digital-marketing", "content-marketing", "seo-services", "influencer-marketing"],
  },
  "email-marketing": {
    id: "email-marketing",
    icon: null,
    ...
    process: [
      ...
      {
        title: "Content Creation",
        description: "We create engaging and personalized email content that resonates with your audience.",
        icon: "Edit",
      },
      {
        title: "Design",
        description: "We design visually appealing and responsive email templates that align with your brand identity.",
        icon: "PenTool",
      },
      {
        title: "Campaign Execution",
    ...
    technologies: [
      ...
      },
      {
        name: "HubSpot",
        icon: "Inbox",
        description: "A marketing automation tool for creating personalized email campaigns and automated sequences.",
      },
      {
        name: "A/B Testing Tools",
        icon: "TestTube",
        description: "Tools for conducting A/B tests to optimize email subject lines, content, and designs.",
      },
      {
        name: "Google Analytics",
        icon: "BarChart",
        description: "A tool for tracking website traffic and conversions from email campaigns.",
      },
    ],
    caseStudies: [
      {
        ...
        results: "Increased open rates by 30%, higher click-through rates, and a 20% increase in sales.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Improved user retention, higher engagement rates, and reduced churn by 15%.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Increased subscriber engagement, higher website traffic, and improved customer loyalty.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
      {
        ...
        answer: "We tailor email content and design to align with Saudi cultural preferences and market trends.",
      },
      {
        question: "Can you create automated email sequences?",
        answer: "Yes, we create automated email sequences for lead nurturing, onboarding, and re-engagement.",
      },
      {
      ...
      },
      {
        ...
        answer: "Yes, we design emails in both Arabic and English to cater to the bilingual Saudi market.",
      },
    ],
    relatedServices: ["digital-marketing", "content-marketing", "social-media-marketing", "seo-services"],
  },
  "content-marketing": {
    ...
    category: "marketing",
    pageTitle: "Content Marketing Services in Saudi Arabia | Attract & Engage Your Audience",
    metaDescription:
    ...
    technologies: [
      {
        name: "WordPress",
        icon: "Wordpress",
        description: "A content management system for publishing and managing blog posts and website content.",
      },
      {
        name: "Canva",
        icon: "Image",
        description: "A design tool for creating visually appealing social media graphics and infographics.",
      },
      {
        name: "Adobe Premiere Pro",
        icon: "Video",
        description: "A video editing tool for producing high-quality video content.",
      },
      {
        name: "Google Analytics",
        icon: "BarChart",
        description: "A tool for tracking website traffic and content performance.",
      },
      {
        name: "HubSpot",
        icon: "Inbox",
        description: "A marketing automation tool for managing and distributing content.",
      },
    ],
    caseStudies: [
      {
        ...
        results: "Increased website traffic by 50%, higher engagement rates, and improved search engine rankings.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Improved patient engagement, higher website traffic, and increased appointment bookings.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Increased organic traffic by 40%, higher engagement rates, and improved customer loyalty.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes, we distribute content across multiple channels, including your website, social media, and email.",
      },
    ],
    relatedServices: ["seo-services", "social-media-marketing", "email-marketing", "video-marketing"],
  },
  "video-marketing": {
    id: "video-marketing",
    icon: null,
    ...
    category: "marketing",
    pageTitle: "Video Marketing Services in Saudi Arabia | Captivate Your Audience",
    metaDescription:
    ...
    sections: [
      {
        title: "Explainer Videos",
        content: "We create explainer videos that simplify complex concepts and communicate your message effectively.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Promotional Videos",
        content: "We produce promotional videos that highlight your products or services and drive engagement.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Testimonial Videos",
        content: "We create testimonial videos that showcase customer experiences and build trust with your audience.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Social Media Videos",
        content: "We design videos optimized for social media platforms to boost your online presence and engagement.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
    ...
    process: [
      ...
      {
        title: "Production",
        description: "We produce high-quality videos, including filming, editing, and adding effects.",
        icon: "Video",
      },
      {
        title: "Review & Feedback",
        description: "We present the draft video for your review and incorporate your feedback to refine the content.",
        icon: "Presentation",
      },
      {
        title: "Finalization",
        description: "We finalize the video and deliver it in your preferred format for distribution.",
        icon: "CheckCircle",
      },
    ],
    technologies: [
      {
        name: "Adobe Premiere Pro",
        icon: "Video",
        description: "A professional video editing tool for producing high-quality videos.",
      },
      {
        name: "Final Cut Pro",
        icon: "Film",
        description: "A video editing software for creating cinematic and professional videos.",
      },
      {
        name: "After Effects",
        icon: "PlayCircle",
        description: "A tool for adding motion graphics and visual effects to videos.",
      },
      {
        name: "YouTube Analytics",
        icon: "BarChart",
        description: "A tool for tracking video performance and audience engagement on YouTube.",
      },
    ],
    caseStudies: [
      {
      ...
      },
      {
        ...
        client: "Saudi Retail",
        description: "Produced a promotional video to highlight the client’s new product line and drive sales.",
        results: "Increased product awareness, higher sales, and improved brand recognition.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        client: "Al-Noor Healthcare",
        description: "Created testimonial videos showcasing patient experiences to build trust and credibility.",
        results: "Improved patient trust, higher engagement rates, and increased appointment bookings.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes, we create videos in both Arabic and English to cater to the bilingual Saudi market.",
      },
      {
        question: "Do you provide video analytics?",
        answer: "Yes, we track and analyze video performance, providing insights and recommendations for optimization.",
      },
      {
        question: "Can you optimize videos for social media?",
        answer: "Yes, we design videos optimized for social media platforms to boost engagement and reach.",
      },
    ],
    relatedServices: ["content-marketing", "social-media-marketing", "motion-graphics", "brand-identity"],
  },
  "marketing-analytics": {
    ...
    category: "marketing",
    pageTitle: "Marketing Analytics Services in Saudi Arabia | Measure & Optimize Campaigns",
    metaDescription:
    ...
    sections: [
      ...
      },
      {
        ...
        content: "We use data-driven insights to optimize your marketing strategies and improve campaign performance.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    process: [
      {
        ...
        description: "We collect data from your marketing campaigns, website, and other relevant sources.",
        icon: "Database",
      },
      {
        title: "Analysis",
        description: "We analyze the data to identify trends, patterns, and areas for improvement.",
        icon: "BarChart",
      },
      {
        title: "Reporting",
        description: "We provide detailed reports with actionable insights and recommendations.",
        icon: "FileText",
      },
      {
        title: "Optimization",
        description: "We use the insights to optimize your marketing strategies and improve performance.",
        icon: "TrendingUp",
      },
      {
        title: "Continuous Monitoring",
        description: "We continuously monitor your campaigns and provide ongoing recommendations for improvement.",
        icon: "Activity",
      },
    ],
    technologies: [
      {
        name: "Google Analytics",
        icon: "BarChart",
        description: "A powerful tool for tracking website traffic, user behavior, and campaign performance.",
      },
      {
        name: "Tableau",
        icon: "PieChart",
        description: "A data visualization tool for creating interactive and insightful reports.",
      },
      {
        name: "HubSpot",
        icon: "Inbox",
        description: "A marketing automation tool for tracking campaign performance and ROI.",
      },
      {
        name: "Power BI",
        icon: "TrendingUp",
        description: "A business analytics tool for visualizing data and sharing insights.",
      },
      {
        name: "SEMrush",
        icon: "Search",
        description: "An SEO and marketing analytics tool for tracking campaign performance and competitor analysis.",
      },
    ],
    caseStudies: [
      {
        ...
        results: "Increased ROI by 25%, improved campaign performance, and higher customer engagement.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Improved customer targeting, higher sales, and increased customer retention.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        ...
        results: "Increased ROI by 30%, improved campaign performance, and higher customer satisfaction.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
    ...
    relatedServices: ["seo-services", "social-media-marketing", "content-marketing", "email-marketing"],
  },
  "influencer-marketing": {
    ...
    description:
      "Strategic influencer marketing campaigns to amplify your brand’s reach and engage your target audience.",
    longDescription:
      "We connect your brand with the right influencers in Saudi Arabia to amplify your reach, build trust, and drive engagement. Our influencer marketing campaigns are tailored to your business goals and target audience, ensuring measurable results.",
    benefits: [
      "Increased brand awareness",
      "Higher audience engagement",
    ...
    category: "marketing",
    pageTitle: "Influencer Marketing Services in Saudi Arabia | Amplify Your Reach",
    metaDescription:
      "Amplify your brand’s reach with our influencer marketing services in Saudi Arabia. We connect you with the right influencers to engage your target audience and drive results.",
    metaKeywords: [
      "influencer marketing Saudi Arabia",
      "influencer campaigns Riyadh",
      "social media influencers KSA",
      "influencer outreach Saudi",
      "influencer content collaboration",
      "influencer ROI measurement",
      "Vision 2030 influencer marketing",
    ],
    heroImage: "/placeholder.svg?height=800&width=1600",
    overview:
      "Our Influencer Marketing services help Saudi businesses amplify their reach and engage their target audience through strategic partnerships with influencers. We identify the right influencers, develop tailored campaigns, and measure performance to ensure your brand achieves its goals.",
    sections: [
      {
        title: "Influencer Identification & Outreach",
        content:
          "We identify and connect with the right influencers in Saudi Arabia who align with your brand and target audience.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Campaign Strategy Development",
        content:
          "We develop customized influencer marketing strategies that align with your business goals and target audience.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Content Collaboration",
        content:
          "We collaborate with influencers to create authentic and engaging content that resonates with your audience.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Performance Tracking",
        content:
          "We track and analyze the performance of your influencer campaigns, providing insights and recommendations.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "ROI Measurement",
        content:
          "We measure the ROI of your influencer campaigns to ensure you’re getting the most out of your investment.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    process: [
      {
        title: "Strategy Development",
        description:
          "We start by understanding your business goals and target audience to create a customized influencer marketing strategy.",
        icon: "Search",
      },
      {
        title: "Influencer Identification",
        description: "We identify and connect with the right influencers who align with your brand and audience.",
        icon: "Users",
      },
      {
        title: "Campaign Execution",
        description: "We execute your influencer campaigns, ensuring seamless collaboration and high-quality content.",
        icon: "Rocket",
      },
      {
        title: "Performance Tracking",
        description:
          "We track and analyze campaign performance, providing insights and recommendations for improvement.",
        icon: "BarChart",
      },
      {
        title: "ROI Measurement",
        description: "We measure the ROI of your campaigns to ensure you’re achieving your business goals.",
        icon: "DollarSign",
      },
    ],
    technologies: [
      {
        name: "Influence.co",
        icon: "Users",
        description: "A platform for discovering and connecting with influencers in Saudi Arabia.",
      },
      {
        name: "Hootsuite",
        icon: "Calendar",
        description: "A social media management tool for tracking influencer campaign performance.",
      },
      {
        name: "Google Analytics",
        icon: "BarChart",
        description: "A tool for tracking website traffic and conversions from influencer campaigns.",
      },
      {
        name: "Brandwatch",
        icon: "Search",
        description: "A social listening tool for monitoring influencer campaign performance and audience sentiment.",
      },
    ],
    caseStudies: [
      {
        title: "Influencer Campaign for Saudi Fashion Brand",
        client: "Elegance Boutique",
        description:
          "Executed an influencer marketing campaign for a Saudi fashion brand, partnering with top fashion influencers to promote their new collection.",
        results: "Increased brand awareness, higher engagement rates, and a 30% increase in sales.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Influencer Outreach for Saudi Beauty Brand",
        client: "Saudi Beauty",
        description:
          "Connected a Saudi beauty brand with niche beauty influencers to promote their products and drive engagement.",
        results: "Improved brand credibility, higher engagement rates, and increased product sales.",
        image: "/placeholder.svg?height=600&width=800",
      },
      {
        title: "Influencer Campaign for Saudi Food Brand",
        client: "Saudi Food Brand",
        description: "Collaborated with food influencers to promote a Saudi food brand’s new product line.",
        results: "Increased product awareness, higher engagement rates, and improved customer loyalty.",
        image: "/placeholder.svg?height=600&width=800",
      },
    ],
    faqs: [
      {
        ...
        answer: "We identify influencers who align with your brand values, target audience, and campaign goals.",
      },
      {
        question: "Can you manage influencer relationships?",
        answer: "Yes, we handle influencer outreach, collaboration, and relationship management on your behalf.",
      },
      {
        question: "How do you measure influencer campaign success?",
        answer:
          "We track key metrics such as engagement rates, reach, website traffic, and conversions to measure success.",
      },
      {
        question: "Can you create bilingual influencer campaigns?",
        answer: "Yes, we create campaigns in both Arabic and English to cater to the bilingual Saudi market.",
      },
      {
        question: "Do you provide ROI measurement?",
        answer: "Yes, we measure the ROI of your influencer campaigns to ensure you’re achieving your business goals.",
      },
    ],
    relatedServices: ["social-media-marketing", "content-marketing", "video-marketing", "brand-identity"],
  },
}
