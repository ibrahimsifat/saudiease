    ...
    <div className="bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="pt-24 pb-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-saudi-black">Our Portfolio</h1>
            <p className="text-lg text-gray-600 mb-8">
              Explore our collection of successful digital projects across Saudi Arabia. From e-commerce solutions to
              ZATCA-compliant systems, discover how we've helped businesses achieve their digital transformation goals.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <Button variant="outline" asChild>
                <a href="#portfolio-grid">Browse Projects</a>
              </Button>
            </div>
      ...
      <section id="portfolio-grid" className="py-12">
        <div className="container mx-auto px-4">
              ...
              <div className="col-span-1 md:col-span-2 lg:col-span-3 text-center py-12">
                <div className="bg-gray-50 rounded-lg p-8 max-w-md mx-auto">
                  ...
                  <p className="text-gray-500 mb-4">
                    We couldn't find any projects matching your search criteria. Please try different keywords or browse
                    all projects.
                  </p>
                  <Button
                    onClick={() => {
          ...
          <div className="mt-20 text-center bg-white rounded-xl shadow-md p-8 border border-gray-100">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Ready to Create Your Success Story?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto mb-6">
              Let's work together to build your next digital project. Our team of Saudi market experts is ready to help
